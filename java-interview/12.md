...
今天我要问你的问题是，<font color='#ff5a05'>Java 有几种文件拷贝方式？哪一种最高效？</font>
...
你可以参考：https://en.wikipedia.org/wiki/User_space 。
...
``` javapublic static long copy(Path source, OutputStream out)
throws IOException
```
